...
const countryListAllIsoData = [
    {"code": "0", "code3": "0", "name": "0", "number": "0"},
...
const bootStrapCountryDropdown =  {
    elements: {
        menu:null,
    ...
    init () {
         ...
         this.elements.menu = document.createElement('select')
         this.elements.menu.classList.add("custom-select", "w-25")
         this.elements.menu.setAttribute("id", "country-select")
        //  this.elements.menu.setAttribute("data-width", "50%")
        
       countryListAllIsoData.forEach( (country,index) => {
           if(index == 0) {
           ...
           this.elements.menu.appendChild(option)
        })

         this.elements.menu.classList.add("dropdown-menu")
        //  $(".inputSearch").after(this.elements.main)
        document.getElementById("inputSearch").appendChild(this.elements.menu)
